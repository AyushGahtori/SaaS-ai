...
export const AGENT_CATALOG: AgentCatalogEntry[] = [
    ...
    },
    {
        ...
        name: "LeadGen Agent",
        description:
            "Research target markets, find and enrich prospects, score leads, and keep session-backed lead generation workflows.",
        actions: [
            "run_leadgen",
            "list_leads",
            "get_history",
        ...
        examplePrompts: [
            ...
            "List saved leads from my last logistics prospecting session.",
            "Continue this lead generation search and focus on decision makers with public emails.",
        ],
        provider: "internal",
        category: "sales",
        tags: ["lead-generation", "sales", "prospecting", "enrichment", "crm"],
        requiresConnection: false,
    },
    {
        id: "marketing-agent",
        ...
        description:
            "Generate campaign strategy, product analysis, posters, content variants, and provider-aware marketing sessions.",
        actions: [
            "run_marketing_agent",
            "generate_campaign",
            "analyze_product",
        ...
        examplePrompts: [
            "Create a launch campaign for a new AI sales copilot with three social posts.",
            "Analyze this product image and generate a poster concept for Instagram.",
            "List my recent marketing sessions and continue the latest campaign.",
        ],
        provider: "internal",
        category: "marketing",
        tags: ["marketing", "campaigns", "creative", "poster", "brand"],
        requiresConnection: false,
    },
    {
        id: "aria-podcast-agent",
        name: "ARIA Podcast Agent",
        description:
            "Host podcast-style conversations, build creator scripts, switch show modes, and generate voice-ready audio workflows.",
        actions: [
            "chat",
            "creator_script",
            "host_conversation",
        ...
        examplePrompts: [
            "ARIA, draft a 5 minute podcast script about AI agents in small businesses.",
            "Switch to host mode and interview me about my startup idea.",
            "Turn this intro paragraph into podcast voiceover audio.",
        ],
        provider: "internal",
        category: "media",
        tags: ["podcast", "voice", "script", "creator", "audio"],
        requiresConnection: false,
    },
    {
        id: "pr-copilot-review-agent",
        name: "PR Copilot Review Agent",
        description:
            "Review GitHub pull requests with static analysis, diff chunking, LLM review, dry runs, and optional webhook support.",
        actions: ["dry_run_review", "review_pr", "webhook_status", "list_capabilities"],
        examplePrompts: [
            "Dry-run review AyushGahtori/SaaS-ai PR 42 and summarize the findings.",
            "Check whether PR Copilot webhook credentials are configured.",
            "Review owner/repo pull request 17 and show the comments only.",
        ],
        provider: "github",
        category: "development",
        tags: ["github", "pull-request", "code-review", "static-analysis", "webhook"],
        requiresConnection: false,
    },
    {
        id: "pian-labs-alos-agent",
        name: "Pian Labs ALOS Agent",
        description:
            "Operate logistics entities, inspect shipment records, calculate route status, and run weather-aware operations checks.",
        actions: [
            "run_alos",
            "describe_workspace",
            "summarize_entity",
        ...
        examplePrompts: [
            "Summarize the shipment entity and highlight high-priority operations.",
            "Check the route status from Delhi to Mumbai for this shipment.",
            "List vehicle records and flag anything under maintenance.",
        ],
        provider: "internal",
        category: "operations",
        tags: ["logistics", "shipments", "warehouse", "routing", "operations"],
        requiresConnection: false,
    },
    {
