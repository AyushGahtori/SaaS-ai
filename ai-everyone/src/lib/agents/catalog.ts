...
export const AGENT_CATALOG: AgentCatalogEntry[] = [
    ...
    },
    {
        ...
        name: "LeadGen Agent",
        description:
            "Autonomous B2B lead generation with web search, company enrichment, email discovery, scoring, storage, and session memory.",
        actions: ["run_leadgen", "list_leads", "get_history", "clear_session", "new_session", "list_capabilities"],
        examplePrompts: [
            "Find 25 B2B SaaS founders in Bengaluru who recently raised seed funding",
            "Find decision makers at US logistics companies and score the strongest leads",
            "List the saved leads from my last LeadGen session",
        ],
        provider: "internal",
        category: "sales",
        tags: ["lead generation", "sales", "prospecting", "enrichment", "b2b"],
        requiresConnection: false,
    },
    {
        id: "marketing-agent",
        ...
        description:
            "Create product-aware campaigns, posters, social posts, hashtags, ad copy, and image-driven marketing content.",
        actions: [
            "run_marketing_agent",
            "generate_campaign",
            "analyze_product",
        ...
        examplePrompts: [
            ...
            "Generate a campaign and poster for a productivity app",
            "Edit the latest poster so the CTA is stronger",
        ],
        provider: "internal",
        category: "marketing",
        tags: ["marketing", "campaigns", "poster", "product image", "social"],
        requiresConnection: false,
    },
    {
        ...
        description:
            "Podcast host and creator with host/creator modes, scripts, show notes, voice input, transcription, and text-to-speech.",
        actions: [
            "chat",
            "creator_script",
            "host_conversation",
        ...
        examplePrompts: [
            ...
            "Generate show notes for an episode about developer productivity",
        ],
        provider: "internal",
        category: "media",
        tags: ["podcast", "voice", "script", "tts", "interview"],
        requiresConnection: false,
    },
    {
        ...
        description:
            "Review GitHub pull requests with PR fetching, Bandit, Flake8, diff chunking, LLM review, validation, and webhook support.",
        actions: ["review_pr", "dry_run_review", "webhook_status", "list_capabilities"],
        examplePrompts: [
            "Dry-run review AyushGahtori/SaaS-ai PR 42",
            "Review owner/repo pull request 17 and show findings only",
            "Check whether PR Copilot webhooks are configured",
        ],
        provider: "internal",
        category: "development",
        tags: ["github", "pull request", "code review", "bandit", "flake8"],
        requiresConnection: false,
    },
    {
        ...
        description:
            "Autonomous Logistics Operating System for data onboarding, entity summaries, record operations, and weather-aware routing.",
        actions: [
            "run_alos",
            "describe_workspace",
            "summarize_entity",
        ...
        provider: "internal",
        category: "operations",
        tags: ["logistics", "routing", "weather", "mongo", "operations"],
        requiresConnection: false,
    },
];
