...
> = {
    ...
    "leadgen-agent": {
        iconUrl: makeMonogramIcon("Lead", "#0f766e", "#2563eb"),
        installCount: 1800,
        rating: 4.8,
    ...
    "marketing-agent": {
        iconUrl: makeMonogramIcon("Mktg", "#be123c", "#7c3aed"),
        installCount: 1750,
        rating: 4.7,
        createdAt: "2026-05-03T00:00:00.000Z",
        isFeatured: false,
    ...
    "aria-podcast-agent": {
        iconUrl: makeMonogramIcon("ARIA", "#155e75", "#9333ea"),
        installCount: 1680,
        rating: 4.8,
        createdAt: "2026-05-03T00:00:00.000Z",
        isFeatured: false,
    ...
    "pr-copilot-review-agent": {
        iconUrl: makeMonogramIcon("PR", "#24292f", "#57606a"),
        installCount: 1620,
        rating: 4.7,
        createdAt: "2026-05-03T00:00:00.000Z",
        isFeatured: false,
    ...
    "pian-labs-alos-agent": {
        iconUrl: makeMonogramIcon("ALOS", "#365314", "#047857"),
        installCount: 1580,
        rating: 4.7,
        createdAt: "2026-05-03T00:00:00.000Z",
        isFeatured: false,
