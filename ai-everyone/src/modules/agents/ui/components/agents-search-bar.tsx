  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        className="ui-surface w-full rounded-2xl border py-3.5 pl-12 pr-4 text-sm text-white/92 placeholder-white/28 outline-none transition-[background-color,border-color,box-shadow] focus:border-primary/35 focus:bg-primary/8 focus:shadow-[0_12px_26px_rgb(92_53_229/18%)]"
      />
    </div>
  );
};
