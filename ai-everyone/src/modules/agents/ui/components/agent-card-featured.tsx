...
export const AgentCardFeatured = ({
  ...
  return (
    <div
      className={`group relative flex flex-col justify-end overflow-hidden rounded-2xl border border-white/[0.08] bg-gradient-to-br from-white/[0.06] to-white/[0.02] p-6 backdrop-blur-md transition-all duration-300 hover:border-primary/32 hover:shadow-[0_14px_42px_rgb(92_53_229/26%)] ${
    ...
    >
      ...
      <div className="absolute left-6 top-6 z-20 flex w-[calc(100%-48px)] items-start justify-between gap-2">
        <span className="rounded bg-primary/80 px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-primary-foreground shadow-sm">
          {agent.category}
        </span>
        {!large ? (
