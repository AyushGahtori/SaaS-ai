        ...
        <div className="flex h-full min-h-0 flex-col overflow-hidden">
            <div className="flex items-center justify-between border-b border-white/8 px-6 py-5 xl:px-8">
                <div>
                    ...
                    <h2 className="mt-1 text-xl font-semibold text-white">
                        {conversation?.title || "How can I help you thrive today?"}
                    </h2>
                    {conversation ? (
                        ...
                        <p className="mt-1 text-sm text-white/45">
                            Bloom AI can draw from your notes, habits, and journal to respond.
                        </p>
                    )}
                </div>
            ...
            <div className="custom-scrollbar min-h-0 flex-1 overflow-y-auto px-6 py-6 xl:px-8">
                {!conversation || conversation.messages.length === 0 ? (
                    <div className="flex min-h-full flex-col items-center justify-center pb-8 pt-4 text-center">
                        ...
                        <h3 className="mt-8 max-w-4xl text-5xl font-semibold tracking-tight text-white">
            ...
            <div className="border-t border-white/8 px-4 pb-6 pt-4 xl:px-8">
                <div
                ...
                >
                    ...
                    <div className="flex items-center justify-between gap-3">
                        ...
                        <Button
                            ...
                            className="size-10 rounded-xl bg-white text-black hover:bg-white/90"
                        >
